...
class Track:
    ...
    def add_bomb(self, coordinate: (float, float), angle: float) -> None:
        """
        :param coordinate: coordinate of a bomb
        :param angle: orientation of bomb (radians)
        """
        self.bombs.append((coordinate, angle))
